            ...
            <div class="row ">
                ...
                <div class="col-md-7 comp-grid">
                    ...
                    <div  class=" animated fadeIn">
                        <form id="turnos-add-form" role="form" novalidate enctype="multipart/form-data" class="form form-horizontal needs-validation" action="<?php print_link("turnos/add?csrf_token=$csrf_token") ?>" method="post">
                            <div>
