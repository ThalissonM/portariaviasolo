...
<section class="page">
    ...
    if(isset($_POST['saida']))
    {
        ...
        saida_veiculo_leve($_POST['saida']);
    ...
    <div  class="bg-light p-3 mb-3">
        <div class="container-fluid">
            ...
            <div class="row ">
                ...
                <div class="col-sm-4 ">
                    <h3 class="record-title"><?php print_lang('controle_acesso_ve_culos_leves'); ?></h3>
                ...
                <div class="col-sm-3 ">
                    ...
                    <a  class="btn btn btn-primary my-1" href="<?php print_link("controle_acesso_veiculos_leves/add") ?>">
                            ...
                            <nav class="page-header-breadcrumbs mt-2" aria-label="breadcrumb">
                                <ul class="breadcrumb m-0 p-1">
                                    ...
                                    <li class="breadcrumb-item">
                                        <a class="text-capitalize" href="<?php print_link('controle_acesso_veiculos_leves'); ?>">
                                    ...
                                    ?>
                                    <li class="breadcrumb-item">
                                        <a class="text-capitalize" href="<?php print_link('controle_acesso_veiculos_leves') ?>"><?php print_lang('pesquisa'); ?></a>
                                    </li>
                ...
                <div class="row ">
                    ...
                    <div class="col-md-12 comp-grid">
                        ...
                        <div  class=" animated fadeIn">
                            <div id="controle_acesso_veiculos_leves-list-records">
                                            ...
                                            <tr>
                                                ...
                                                <th class=" td-checkbox">
                                                    ...
                                                    <th class="td-btn">
                                                        ...
                                                        <a class="btn btn-sm btn-success has-tooltip" title="<?php print_lang('ver_registro'); ?>" href="<?php print_link("controle_acesso_veiculos_leves/view/$rec_id"); ?>">
                                                       ...
                                                       <a>
                                                        ...
                                                        <a class="btn btn-sm btn-info has-tooltip" title="<?php print_lang('editar_este_registro'); ?>" href="<?php print_link("controle_acesso_veiculos_leves/edit/$rec_id"); ?>">
                                                        ...
                                                        <a class="btn btn-sm btn-danger has-tooltip record-delete-btn" title="<?php print_lang('excluir_este_registro'); ?>" href="<?php print_link("controle_acesso_veiculos_leves/delete/$rec_id/?csrf_token=$csrf_token&redirect=$current_page"); ?>" data-prompt-msg="Tem certeza de que deseja excluir este registro?" data-display-style="none">
                                        ...
                                        <div class="row">   
                                            <div class="col-sm-4">  
                                                <div class="py-2">  
                                                    ...
                                                    <button data-prompt-msg="<?php print_lang('tem_certeza_de_que_deseja_excluir_esses_registros_'); ?>" data-display-style="none" data-url="<?php print_link("controle_acesso_veiculos_leves/delete/{sel_ids}/?csrf_token=$csrf_token&redirect=$current_page"); ?>" class="btn btn-sm btn-danger btn-delete-selected d-none">
                                            ...
                                            <div class="col">   
                                                ...
                                                $pager->page_name='controle_acesso_veiculos_leves';
