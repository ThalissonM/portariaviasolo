                ...
                <div class="col-md-12 comp-grid">
                    ...
                    <div  class=" animated fadeIn">
                        ...
                        <div class="page-records ">
                            <table class="table table-hover table-borderless table-striped">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <th class="title"> <?php print_lang('tipo'); ?> :</th>
                                        <td class="value"> <?php echo $data['tipo']; ?> </td>
                                    </tr>
                                    ...
                                    <tr>
                                        <th class="title"> <?php print_lang('_ltimo_motorista'); ?> :</th>
                                        <td class="value"> <?php echo $data['nome_motorista']; ?> </td>
                                    </tr>
                                    
                                    
                                    <tr>
                                        <th class="title"> <?php print_lang('nome_cliente'); ?> :</th>
                                        <td class="value"> <?php echo $data['nome_cliente']; ?> </td>
                                    </tr>
                        ...
                        <div class="p-3">
                            ...
                            <a class="btn btn-sm btn-info"  href="<?php print_link("veiculos_clientes/edit/$rec_id"); ?>">
                            ...
                            <a class="btn btn-sm btn-danger record-delete-btn"  href="<?php print_link("veiculos_clientes/delete/$rec_id/?csrf_token=$csrf_token&redirect=$current_page"); ?>" data-prompt-msg="Tem certeza de que deseja excluir este registro?" data-display-style="none">
