                            ...
                            <div>
                                ...
                                <div class="form-group ">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <div class="">
                                                <input id="ctrl-username"  value="<?php  echo $data['username']; ?>" type="text" placeholder="<?php print_lang('entrar_username'); ?>"  required="" name="username"  data-url="api/json/account_username_value_exist/" data-loading-msg="<?php print_lang('checando_disponibilidade_'); ?>" data-available-msg="<?php print_lang('dispon_vel'); ?>" data-unavailable-msg="<?php print_lang('n_o_dispon_vel'); ?>" class="form-control  ctrl-check-duplicate" />
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-8">
                                                <div class="">
                                                    ...
                                                    <select required=""  id="ctrl-role" name="role"  placeholder="<?php print_lang('selecione_um_valor_'); ?>"    class="custom-select" >
                                    ...
                                    <div class="form-group ">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-8">
                                                <div class="">
                                                    <input id="ctrl-id_viasolo"  value="<?php  echo $data['id_viasolo']; ?>" type="text" placeholder="<?php print_lang('entrar_id_viasolo'); ?>"  required="" name="id_viasolo"  class="form-control " />
