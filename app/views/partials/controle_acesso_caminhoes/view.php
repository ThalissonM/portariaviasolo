                ...
                <div class="col-md-12 comp-grid">
                    ...
                    <div  class=" animated fadeIn">
                        ...
                        <div class="page-records ">
                            <table class="table table-hover table-borderless table-striped">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <th class="title"> <?php print_lang('id_cliente'); ?> :</th>
                                        <td class="value"> <?php echo $data['id_cliente_real']; ?> </td>
                                    </tr>
                                    
                                    
                                    <tr>
                                        <th class="title"> <?php print_lang('cliente'); ?> :</th>
                                        <td class="value"> <?php echo $data['nome_cliente_real']; ?> </td>
                                    </tr>
                                    
                                    
                                    <tr>
                                        <th class="title"> <?php print_lang('id_transportadora'); ?> :</th>
                                        <td class="value"> <?php echo $data['clientes_id']; ?> </td>
                                    </tr>
                                    
                                    
                                    <tr>
                                        <th class="title"> <?php print_lang('transportadora'); ?> :</th>
                                    ...
                                    <tr>
                                        <th class="title"> <?php print_lang('idmotorista'); ?> :</th>
                                    ...
                                    <tr>
                                        <th class="title"> <?php print_lang('cliente_permitido'); ?> :</th>
                                        <td class="value"> <?php echo $data['cliente_permitido']; ?> </td>
                                    </tr>
                                    
                                    
                                    <tr>
                                        <th class="title"> <?php print_lang('motorista_permitido'); ?> :</th>
                                        <td class="value"> <?php echo $data['motorista_permitido']; ?> </td>
                                    </tr>
                        ...
                        <div class="p-3">
                            ...
                            <a class="btn btn-sm btn-info"  href="<?php print_link("controle_acesso_caminhoes/edit/$rec_id"); ?>">
                            ...
                            <a class="btn btn-sm btn-danger record-delete-btn"  href="<?php print_link("controle_acesso_caminhoes/delete/$rec_id/?csrf_token=$csrf_token&redirect=$current_page"); ?>" data-prompt-msg="Tem certeza de que deseja excluir este registro?" data-display-style="none">
