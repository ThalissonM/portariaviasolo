                ...
                <div class="col-md-12 comp-grid">
                    ...
                    <div  class=" animated fadeIn">
                        ...
                        <div class="page-records ">
                            <table class="table table-hover table-borderless table-striped">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <th class="title"> <?php print_lang('nome_empresa'); ?> :</th>
                                        <td class="value"> <?php echo $data['nome_empresa']; ?> </td>
                                    </tr>
                        ...
                        <div class="p-3">
                            ...
                            <a class="btn btn-sm btn-info"  href="<?php print_link("clientes/edit/$rec_id"); ?>">
                            ...
                            <a class="btn btn-sm btn-danger record-delete-btn"  href="<?php print_link("clientes/delete/$rec_id/?csrf_token=$csrf_token&redirect=$current_page"); ?>" data-prompt-msg="Tem certeza de que deseja excluir este registro?" data-display-style="none">
