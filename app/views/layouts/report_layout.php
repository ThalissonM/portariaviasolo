			...
			<div class="row">
				<div class="col-sm-4">
					<a class="btn btn-secondary btn-sm" href="<?php print_link('') ?>">
						&laquo; <?php print_lang('costas'); ?>
					</a>
				</div>
				<div class="col-sm-8">
					<button class="btn btn-danger btn-sm" onclick="printPage()"><img src="<?php print_link("assets/js/export-plugin/images/print.svg") ?>" /> <?php print_lang('impress_o_pdf'); ?> <img src="<?php print_link("assets/js/export-plugin/images/pdf.svg") ?>" /></button>
					
					<button   class="btn btn-warning  btn-sm" onclick="exportPng()"> <?php print_lang('salvar_png'); ?> <img src="<?php print_link("assets/js/export-plugin/images/png.svg") ?>" /> </button>
					<button  class="btn btn-success  btn-sm" onclick="exportCsv()"> <?php print_lang('exportar_csv'); ?> <img src="<?php print_link("assets/js/export-plugin/images/csv.svg") ?>" /> </button>
					<button  class="btn btn-info  btn-sm" onclick="exportExcel()"> <?php print_lang('exportar_excel'); ?> <img src="<?php print_link("assets/js/export-plugin/images/xls.svg") ?>" /> </button>
					<button  class="btn btn-primary  btn-sm" onclick="exportWord()"> <?php print_lang('exportar_word'); ?> <img src="<?php print_link("assets/js/export-plugin/images/doc.svg") ?>" /> </button>
				</div>
			</div>
			</div>
		</div>
		<div class="container-fluid">
			<div class="row">
				<div class="col-sm-2 d-print-none">	
					<div class="card my-4">
						<div class="card-header"><?php print_lang('imprimir_configura_es_da_p_gina'); ?></div>
						<div class="card-body">
							<div class="form-group">
								<?php print_lang('selecione_o_tamanho_do_papel'); ?>
							...
							<div class="form-group">
								<label class="btn btn-primary btn-block"><input onclick="toggleCompanyHeader()" checked="checked" type="checkbox" /> <?php print_lang('mostrar_cabe_alho'); ?></label>
							</div>
							<div class="form-group">
								<button onclick="removePageLinks()" class="btn btn-warning btn-block "> <?php print_lang('remover_links_da_p_gina'); ?></button>
							</div>
							
							<div class="page-title"><?php print_lang('exportar_campos_de_p_gina'); ?></div>
