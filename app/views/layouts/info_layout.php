			...
			<div class="collapse navbar-collapse" id="navbarTogglerDemo01">
				<ul class="navbar-nav mr-auto mt-2 mt-lg-0">
					<li class="nav-item active">
						<a class="nav-link" href="<?php print_link(HOME_PAGE) ?>"><?php print_lang('casa'); ?></a>
					</li>
					<li class="nav-item active">
						<a class="nav-link" href="<?php print_link('info/about') ?>"><?php print_lang('sobre_n_s'); ?></a>
					</li>
					<li class="nav-item active">
						<a class="nav-link" href="<?php print_link('info/help') ?>"><?php print_lang('ajuda_e_faq'); ?></a>
					</li>
					<li class="nav-item active">
						<a class="nav-link" href="<?php print_link('info/contact') ?>"><?php print_lang('contate_nos'); ?></a>
					</li>
				</ul>
			</div>
		</nav>
