	...
	<!-- Page Footer Ends -->
				...
				<div class="modal-dialog" role="document">
					<div class="modal-content">
						<div class="modal-header">
							<h5 class="modal-title"><?php print_lang('apagar_registro'); ?></h5>
						...
						<div class="modal-footer">
							<button type="button" class="btn btn-secondary" data-dismiss="modal"><?php print_lang('cancelar'); ?></button>
							<a href="" id="delete-record-modal-btn" class="btn btn-primary"><?php print_lang('excluir'); ?></a> 
						</div>
					</div>
				</div>
			</div>
			...
			<template id="page-loading-indicator">
				<div class="p-2 text-center m-2 text-muted">
					...
					<h4 class="p-3 mt-2 font-weight-light"><?php print_lang('carregando_'); ?></h4>
				</div>
			</template>
			<template id="page-saving-indicator">
				<div class="p-2 text-center m-2 text-muted">
					<div class="lds-dual-ring"></div>
					<h4 class="p-3 mt-2 font-weight-light"><?php print_lang('registro_de_economia'); ?></h4>
				</div>
			</template>
			<template id="inline-loading-indicator">
				<div class="loader"></div> <div class="bold d-inline-block mx-2 mb-4"><?php print_lang('carregando_'); ?></div>
			</template>
