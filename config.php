<?php
	...
	define('SITE_NAME' , "Portaria VIASOLO");
	...
	define('APP_ID',"68dd720bbbff05ec71f2e9d826ebd379");
	...
	define('DB_PASSWORD','');
	define('DB_NAME','portariaviasolov1');
	...
	define('USER_ID',(isset($_SESSION[APP_ID.'user_data']) ? $_SESSION[APP_ID.'user_data']['id_viasolo'] : null ));
