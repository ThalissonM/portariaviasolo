				...
				<form class="mt-3" id="form<?php echo $form_id ?>" action="<?php echo ($this->set_link()); ?>" method="get">
					<div class="row justify-content-center">
						...
						<div class="<?php echo $detail_page_class; ?>">
							...
							?>
									<small class="text-muted"> <?php print_lang('registros'); ?>  : <?php echo $record_position; ?> <?php print_lang('do'); ?>  <?php echo $this->total_records; ?></small>
							...
							?>
									| <small class="text-muted"><?php print_lang('p_gina'); ?> : 
										...
										<?php print_lang('do'); ?> <?php echo $numofpages; ?>
									</small>
							<?php 
								}
