			...
			<div class="modal-dialog modal-dialog-centered modal-sm">
				<div class="modal-content">
					<div class="modal-header">
						<h4 class="modal-title"><?php print_lang('importar_dados'); ?></h4>
						<button type="button" class="close" data-dismiss="modal">&times;</button>
					</div>
					<div class="modal-body">
						<label><?php print_lang('selecione_um_arquivo_para_importar'); ?> <input required="required" class="form-control form-control-sm" type="file" name="file" /> </label>
						<small class="text-muted"><?php print_lang(''); ?>(csv , json)</small>
						
					</div>
					<div class="modal-footer">
						<button type="reset" class="btn btn-secondary" data-dismiss="modal"><?php print_lang('fechar'); ?></button>
						<button type="submit" class="btn btn-primary"><?php print_lang('importar_dados'); ?></button>
					</div>
				</div>
			</div>
		</form>
